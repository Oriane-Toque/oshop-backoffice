    ...
    <div class="col-12 col-md-6">
      <div class="card text-white mb-3">
        ...
        <div class="card-body">
          ...
          <a href="<?= $router->generate('catalog-categories'); ?>" class="btn btn-block btn-success">Voir plus</a>
        </div>
      </div>
    </div>
    <div class="col-12 col-md-6">
      <div class="card text-white mb-3">
        ...
        <div class="card-body">
          ...
          <a href="<?= $router->generate('catalog-products'); ?>" class="btn btn-block btn-success">Voir plus</a>
        </div>
      </div>
    </div>
  </div>
